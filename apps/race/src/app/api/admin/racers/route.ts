...
const schema = z.object({ raceId: z.string().uuid(), startNumber: z.string().optional(), firstName: z.string().min(1), lastName: z.string().min(1), email: z.string().optional(), phone: z.string().optional(), routeName: z.string().optional() });
